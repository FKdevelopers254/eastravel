      ...
      Column(
        ...
        children:  [
          ...
          Container(
            ...
            child:
            Text(
              'Welcome to our travel planner template, the ultimate tool for planning your dream vacation! With our user-friendly and customizable template, you can easily organize all aspects of your trip, from flights and accommodations to activities and dining reservations.Our template includes pre-made sections for each category of your trip, along with space to add your own notes and details. You can also easily adjust the formatting to suit your needs and preferences.We know that planning a trip can be overwhelming, but with our template, you can relax and enjoy the process. Simply fill in the details of your itinerary, and our planner will do the rest. You can even set reminders and notifications for important dates and events, so you don\'t miss a thing.Whether you\'re planning a romantic getaway, a family vacation, or an adventure-filled trip with friends, our travel planner template has everything you need to make your dream vacation a reality. So why wait? Download our template today and start planning your next adventure\!',
